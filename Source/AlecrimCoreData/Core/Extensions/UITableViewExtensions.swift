...
//
    ...
    extension FetchRequestController {
        ...
        @discardableResult
        public func bind<CellType: UITableViewCell>(to tableView: UITableView, updateOnChanges: Bool = true, rowAnimation: UITableViewRowAnimation = .fade, sectionOffset: Int = 0, cellConfigurationHandler: ((CellType, IndexPath) -> Void)? = nil) -> Self {
